...
const BIN_ID  = "6a086754adc21f119aabd71c";
const API_KEY = "$2a$10$Uv2k9R4NLWgKfOeNNFGWLOON/Sg3JuUej7kt9stjDrpCp4y8/TT5e";
const BIN_URL = `https://api.jsonbin.io/v3/b/${BIN_ID}`;

const DATES   = ["5/15","5/16","5/17","5/18","5/19","5/20","5/21","5/22","5/23","5/24","5/25","5/26"];
const DAYS    = ["Fri","Sat","Sun","Mon","Tue","Wed","Thu","Fri","Sat","Sun","Mon","Tue"];
          ...
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:14 }}>
            <div style={{ display:"flex", alignItems:"center", gap:10 }}>
              ...
              <div>
                ...
                <div style={{ fontSize:11, color:"#64748b" }}>May 15–26 · Shared League Manager</div>
              </div>
            </div>
